    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 p-5">
      {items.map((item, index) => (
        <motion.div
          ...
          exit={{ opacity: 0, x: index % 2 === 0 ? -100 : 100, y: index % 3 === 0 ? 100 : 0 }} // Animación al salir
          transition={{ duration: 0.4, delay: index * 0.1 }} // Reduje la duración a 0.4
        ...
        >
          <a href="#">
            <motion.div
              ...
              transition={{ duration: 0.4 }} // Reduje la duración a 0.4
              viewport={{ once: false }}
            >
              <Image
                src={item.imageSrc}
          ...
          <motion.div
            ...
            transition={{ duration: 0.4, delay: index * 0.2 }} // Reduje la duración a 0.4
            viewport={{ once: false }}
          >
            <a href="#">
              <motion.h5
            ...
            <motion.p
              ...
              initial={{ x: 50, opacity: 0 }}
              whileInView={{ x: 0, opacity: 1 }} // Animación de movimiento en el eje X y opacidad
              transition={{ duration: 0.4, delay: index * 0.3 }} // Reduje la duración a 0.4
              viewport={{ once: false }}
            >
              {item.description}
            </motion.p>
            <motion.a
              ...
              transition={{ duration: 0.4, delay: index * 0.4 }} // Reduje la duración a 0.4
              viewport={{ once: false }}
            >
              {item.buttonText}
            </motion.a>
